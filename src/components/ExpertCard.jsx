            ...
            <div className="flex">
                ...
                <div className="expert-text-box">
                    ...
                    <div className="expert-detail">
                        {name} has a <em>{qualification}</em> degree and an assorted experiencce in the Sports industry for <strong>{experience}</strong> years. {gender ==='female'? "She": "He"} {type==='nut'?'work involves optimizing the calorie in-take and enhancing the metabolism which ensures a healthy body and a sharper mind.':'is highly skilled and motivating when it comes to being a personal training.'}
                    </div>
                </div>
            </div>
